...
//    }
    ...
    // 설문 분석 시작
    @PostMapping(value = "/analyze/research/analyze/create")
    ...
    // 설문 상세 분석 조회
    @GetMapping(value = "/analyze/research/analyze/{id}")
